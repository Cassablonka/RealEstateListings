...
chrome_path = '/Users/Cassa/chromedriver (Your chrome driver path)'

# Setting your google form URL prehand
GOOGLE_FORM_URL = 'Get the shorten URL of your google form'

# Setting the URL of the specific search depending upon your requirements
URL = 'https://www.99acres.com/search/property/buy/kharadi?city=19&bedroom_num=2&class=A&locality=839&preference=' \
      'S&area_unit=1&budget_max=125&budget_min=120&availability=1%2C2&res_com=R'
...
property_names = [property_name.a.text for property_name in properties]

# To get all the links linked to certain property
property_links = [property_link.a.get('href') for property_link in properties]
